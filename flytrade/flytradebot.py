"""
Flytrade is the main module of this bot. It contains the class Flytrade()
"""
import logging
import traceback
...
from flytrade import constants
from flytrade.configuration import validate_config_consistency
from flytrade.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from flytrade.data.converter import order_book_to_dataframe
from flytrade.data.dataprovider import DataProvider
from flytrade.edge import Edge
from flytrade.enums import (ExitCheckTuple, ExitType, RPCMessageType, SignalDirection, State,
                             TradingMode)
from flytrade.exceptions import (DependencyException, ExchangeError, InsufficientFundsError,
                                  InvalidOrderException, PricingError)
from flytrade.exchange import (ROUND_DOWN, ROUND_UP, remove_exchange_credentials,
                                timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds)
from flytrade.misc import safe_value_fallback, safe_value_fallback2
from flytrade.mixins import LoggingMixin
from flytrade.persistence import Order, PairLocks, Trade, init_db
from flytrade.persistence.key_value_store import set_startup_time
from flytrade.plugins.pairlistmanager import PairListManager
from flytrade.plugins.protectionmanager import ProtectionManager
from flytrade.resolvers import ExchangeResolver, StrategyResolver
from flytrade.rpc import RPCManager
from flytrade.rpc.external_message_consumer import ExternalMessageConsumer
from flytrade.rpc.rpc_types import (ProfitLossStr, RPCCancelMsg, RPCEntryMsg, RPCExitCancelMsg,
                                     RPCExitMsg, RPCProtectionMsg)
from flytrade.strategy.interface import IStrategy
from flytrade.strategy.strategy_wrapper import strategy_safe_wrapper
from flytrade.util import FtPrecise
from flytrade.util.migrations import migrate_binance_futures_names
from flytrade.wallets import Wallets


logger = logging.getLogger(__name__)


class FlytradeBot(LoggingMixin):
    """
    Flytrade is the main class of the bot.
    ...
    def __init__(self, config: Config) -> None:
        ...
        # initialization, even before Flytradebot has a chance to start its throttling,
        # so anything in the Flytradebot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, flytrade may try to recreate stoploss_on_exchange orders
    ...
    def handle_onexchange_order(self, trade: Trade):
        ...
        try:
            ...
            # catching https://github.com/flytrade/flytrade/issues/9025
