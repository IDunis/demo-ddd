class FlytradeException(Exception):
    """
    Flytrade base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(FlytradeException):
    """
...
class DependencyException(FlytradeException):
    """
...
class StrategyError(FlytradeException):
    """
