...
class Screener:
    def __init__(
        ...
        Function Signatures:
        init(screener_state: trapilot.ScreenerState)
        evaluator(symbol: str, screener_state: trapilot.ScreenerState)
        final(ScreenerState: trapilot.ScreenerState)
        formatter(raw_results: dict, screener_state: trapilot.ScreenerState)
        ...
        if trapilot.is_deployed:
            trapilot.reporter.export_screener(self)
    ...
    def notify(self, message: str = None):
        ...
        trapilot.reporter.email(use_str)

        trapilot.reporter.text(use_str)
