...
from trapilot.exchange import list_available_exchanges, market_is_active
from trapilot.misc import parse_db_uri_for_logging, plural
...
def start_show_trades(args: Dict[str, Any]) -> None:
    ...
    from trapilot.persistence import Trade, init_db
