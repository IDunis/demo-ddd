...
def start_backtesting_show(args: Dict[str, Any]) -> None:
    ...
    from trapilot.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: Dict[str, Any]) -> None:
    ...
    try:
        ...
        from trapilot.optimize.hyperopt import Hyperopt
...
def start_edge(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from trapilot.optimize.edge_cli import EdgeCli
...
def start_lookahead_analysis(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from trapilot.optimize.analysis.lookahead_helpers import LookaheadAnalysisSubFunctions
...
def start_recursive_analysis(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from trapilot.optimize.analysis.recursive_helpers import RecursiveAnalysisSubFunctions
