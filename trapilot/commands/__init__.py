...
from trapilot.commands.data_commands import (start_convert_data,
                                             start_convert_trades,
                                             start_download_data,
                                             start_list_data)
from trapilot.commands.db_commands import start_convert_db
from trapilot.commands.deploy_commands import (start_create_userdir,
                                               start_install_ui,
                                               start_new_strategy)
from trapilot.commands.hyperopt_commands import (start_hyperopt_list,
                                                 start_hyperopt_show)
from trapilot.commands.list_commands import (start_list_exchanges,
                                             start_list_freqAI_models,
                                             start_list_markets,
                                             start_list_strategies,
                                             start_list_timeframes,
                                             start_show_trades)
from trapilot.commands.optimize_commands import (start_backtesting,
...
from trapilot.commands.plot_commands import (start_plot_dataframe,
                                             start_plot_profit)
