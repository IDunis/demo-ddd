...
from trapilot.configuration import running_in_docker
from trapilot.constants import Config
from trapilot.exceptions import OperationalException
from trapilot.rpc.api_server.uvicorn_threaded import UvicornServer
from trapilot.rpc.api_server.ws.message_stream import MessageStream
from trapilot.rpc.rpc import RPC, RPCException, RPCHandler
...
class ApiServer(RPCHandler):
    ...
    def __init__(self, config: Config, standalone: bool = False) -> None:
        ...
        self.app = FastAPI(title="Trapilot API",
    ...
    def configure_app(self, app: FastAPI, config):
        from trapilot.rpc.api_server.api_auth import http_basic_or_jwt_token, router_login
        from trapilot.rpc.api_server.api_background_tasks import router as api_bg_tasks
        from trapilot.rpc.api_server.api_backtest import router as api_backtest
        from trapilot.rpc.api_server.api_v1 import router as api_v1
        from trapilot.rpc.api_server.api_v1 import router_public as api_v1_public
        from trapilot.rpc.api_server.api_ws import router as ws_router
        from trapilot.rpc.api_server.deps import is_webserver_mode
        from trapilot.rpc.api_server.web_ui import router_ui
