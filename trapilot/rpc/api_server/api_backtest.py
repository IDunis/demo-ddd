...
from trapilot.data.btanalysis import (delete_backtest_result, get_backtest_result,
...
from trapilot.rpc.api_server.api_schemas import (BacktestHistoryEntry, BacktestMetadataUpdate,
...
def __run_backtest_bg(btconfig: Config):
    from trapilot.optimize.optimize_reports import generate_backtest_stats, store_backtest_stats
