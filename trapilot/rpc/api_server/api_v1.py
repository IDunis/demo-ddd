...
from trapilot.data.history import get_datahandler
from trapilot.enums import CandleType, TradingMode
from trapilot.exceptions import OperationalException
from trapilot.rpc import RPC
from trapilot.rpc.api_server.api_schemas import (AvailablePairs, Balances,
                                                 BlacklistPayload,
                                                 BlacklistResponse, Count,
                                                 DailyWeeklyMonthly,
                                                 DeleteLockRequest,
                                                 DeleteTrade, Entry,
                                                 ExchangeListResponse, Exit,
                                                 ForceEnterPayload,
                                                 ForceEnterResponse,
                                                 ForceExitPayload,
                                                 FreqAIModelListResponse,
                                                 Health, Locks, Logs, MixTag,
                                                 OpenTradeSchema, PairHistory,
                                                 PerformanceEntry, Ping,
                                                 PlotConfig, Profit, ResultMsg,
                                                 ShowConfig, Stats, StatusMsg,
                                                 StrategyListResponse,
                                                 StrategyResponse, SysInfo,
                                                 Version, WhitelistResponse)
from trapilot.rpc.api_server.deps import (get_config, get_exchange, get_rpc,
                                          get_rpc_optional)
...
def list_exchanges(config=Depends(get_config)):
    from trapilot.exchange import list_available_exchanges
