...
from trapilot.constants import (DEFAULT_AMOUNT_RESERVE_PERCENT, NON_OPEN_EXCHANGE_STATES, BidAsk,
                                 BuySell, Config, EntryExit, ExchangeConfig,
                                 ListPairsWithTimeframes, MakerTaker, OBLiteral, PairWithTimeframe)
from trapilot.data.converter import clean_ohlcv_dataframe, ohlcv_to_dataframe, trades_dict_to_list
from trapilot.enums import OPTIMIZE_MODES, CandleType, MarginMode, PriceType, RunMode, TradingMode
from trapilot.exceptions import (DDosProtection, ExchangeError, InsufficientFundsError,
                                  InvalidOrderException, OperationalException, PricingError,
                                  RetryableOrderError, TemporaryError)
from trapilot.exchange.common import (API_FETCH_ORDER_RETRY_COUNT, remove_exchange_credentials,
                                       retrier, retrier_async)
from trapilot.exchange.exchange_utils import (ROUND, ROUND_DOWN, ROUND_UP, CcxtModuleType,
...
from trapilot.misc import (chunks, deep_merge_dicts, file_dump_json, file_load_json,
...
class Exchange:
    ...
    def validate_timeframes(self, timeframe: Optional[str]) -> None:
        ...
        if (
            ...
            raise OperationalException("Timeframes < 1m are currently not supported by Trapilot.")
