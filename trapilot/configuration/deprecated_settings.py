...
def check_conflicting_settings(
    ...
    if name_new in section_new_config and name_old in section_old_config:
        ...
        raise OperationalException(
            ...
            "This deprecated setting will be removed in the next versions of Trapilot. "
...
def process_deprecated_setting(
    ...
    if name_old in section_old_config:
        ...
        logger.warning(
            ...
            "will be removed in the next versions of Trapilot. "
...
def process_temporary_deprecated_settings(config: Config) -> None:
    ...
    process_deprecated_setting(
        config, None, "forcebuy_enable", None, "force_entry_enable"
    )
    ...
    if config.get("webhook"):
        process_deprecated_setting(
            config, "webhook", "webhookbuy", "webhook", "webhookentry"
        )
        process_deprecated_setting(
        ...
        process_deprecated_setting(
            config, "webhook", "webhooksell", "webhook", "webhookexit"
        )
        process_deprecated_setting(
    ...
    process_removed_setting(
        config, "experimental", "use_sell_signal", None, "use_exit_signal"
    )
    process_removed_setting(
        config, "experimental", "sell_profit_only", None, "exit_profit_only"
    )
    process_removed_setting(
        config,
        "experimental",
    ...
    process_removed_setting(
        config, "ask_strategy", "use_sell_signal", None, "use_exit_signal"
    )
    process_removed_setting(
        config, "ask_strategy", "sell_profit_only", None, "exit_profit_only"
    )
    process_removed_setting(
