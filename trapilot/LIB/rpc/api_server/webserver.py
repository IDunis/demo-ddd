...
from trapilot.LIB.configuration import running_in_docker
from trapilot.LIB.constants import Config
from trapilot.LIB.exceptions import OperationalException
from trapilot.LIB.rpc.api_server.uvicorn_threaded import UvicornServer
from trapilot.LIB.rpc.api_server.ws.message_stream import MessageStream
from trapilot.LIB.rpc.rpc import RPC, RPCException, RPCHandler
...
class ApiServer(RPCHandler):
    ...
    def configure_app(self, app: FastAPI, config):
        from trapilot.LIB.rpc.api_server.api_auth import http_basic_or_jwt_token, router_login
        from trapilot.LIB.rpc.api_server.api_background_tasks import router as api_bg_tasks
