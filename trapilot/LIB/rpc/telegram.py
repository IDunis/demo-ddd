...
from trapilot.LIB.enums import MarketDirection, RPCMessageType, SignalDirection, TradingMode
...
class Telegram(RPCHandler):
    ...
    def _add_analyzed_candle(self, pair: str) -> str:
        ...
        if candle_val != 'off':
            if candle_val == 'ohlc':
                analyzed_df, _ = self._rpc._tradebot.dataprovider.get_analyzed_dataframe(
