...
from trapilot.LIB.misc import deep_merge_dicts
from trapilot.LIB.optimize.hyperopt_tools import HyperoptTools
from trapilot.LIB.strategy.parameters import BaseParameter
    ...
    def ft_load_hyper_params(self, hyperopt: bool = False) -> None:
        ...
        * Parameter defaults
        ...
        protection_params = deep_merge_dicts(
            self._ft_params_from_file.get("protection", {}),
