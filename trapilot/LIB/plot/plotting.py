...
from trapilot.LIB.data.btanalysis import (analyze_trade_parallelism, extract_trades_of_period,
                                       load_trades)
...
from trapilot.LIB.data.metrics import (calculate_max_drawdown, calculate_underwater,
...
def plot_profit(config: Config) -> None:
    ...
    store_plot_file(fig, filename='trapilot-profit-plot.html',
                    directory=config['user_data_dir'] / 'plot',
