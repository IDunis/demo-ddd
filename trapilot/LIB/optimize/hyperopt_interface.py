...
from trapilot.LIB.misc import round_dict
from trapilot.LIB.optimize.space import SKDecimal
...
class IHyperOpt(ABC):
    ...
    def generate_estimator(
        self, dimensions: List[Dimension], **kwargs
    ) -> EstimatorType:
        """
    ...
    def roi_space(self) -> List[Dimension]:
        ...
        It's used by Trapilot by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy Trapilot roi_space()
