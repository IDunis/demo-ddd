...
import trapilot.exchange as exchanges
from trapilot.LIB.constants import Config, ExchangeConfig
from trapilot.LIB.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in trapilot.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("trapilot.", ""),
                    }
                )
        return result
