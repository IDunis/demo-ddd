...
from trapilot.LIB.constants import (USER_DATA_FILES, USERPATH_FREQAIMODELS, USERPATH_HYPEROPTS,
    ...
    if not folder.is_dir():
        if create_dir:
            ...
            raise OperationalException(
                ...
                "Please use `trapilot create-userdir` to create a user directory")
