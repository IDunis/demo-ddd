"""
Various tool function for Trapilot and scripts
"""
...
from trapilot.LIB.enums import SignalTagType, SignalType
...
def safe_value_fallback(
    obj: dict, key1: str, key2: Optional[str] = None, default_value=None
):
    """
...
def safe_value_fallback2(
    dict1: dictMap, dict2: dictMap, key1: str, key2: str, default_value=None
):
    """
...
def append_candles_to_dataframe(
