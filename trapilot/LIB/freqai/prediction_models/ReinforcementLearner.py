...
from trapilot.LIB.freqai.RL.Base5ActionRLEnv import Actions, Base5ActionRLEnv, Positions
from trapilot.LIB.freqai.RL.BaseEnvironment import BaseEnvironment
from trapilot.LIB.freqai.RL.BaseReinforcementLearningModel import (
...
class ReinforcementLearner(BaseReinforcementLearningModel):
    ...
    ```
    from trapilot.LIB.freqai.prediction_models.ReinforcementLearner import ReinforcementLearner
    ...
    trapilot trade --freqaimodel MyCoolRLModel --config config.json --strategy SomeCoolStrat
    ...
    def fit(self, data_dictionary: Dict[str, Any], dk: FreqaiDataKitchen, **kwargs):
        ...
        if dk.pair not in self.dd.model_dictionary or not self.continual_learning:
            ...
            logger.info(
                "Continual training activated - starting training from previously "
                "trained agent."
            )
