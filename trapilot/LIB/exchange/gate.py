...
from trapilot.LIB.enums import MarginMode, PriceType, TradingMode
...
class Gate(Exchange):
    """
    Gate.io exchange class. Contains adjustments needed for Trapilot to work
    with this exchange.
    ...
    def fetch_stoploss_order(self, order_id: str, pair: str, params: Dict = {}) -> Dict:
        ...
        if self.trading_mode == TradingMode.FUTURES:
            if order["status"] == "closed":
                ...
                if new_orderid:
                    order1 = self.fetch_order(
                        order_id=new_orderid, pair=pair, params=params
                    )
