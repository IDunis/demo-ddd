...
from trapilot.LIB.enums import CandleType, PriceType, RPCMessageType

DOCS_LINK = "https://www.trapilot.io/en/stable"
...
ORDERTIF_POSSIBILITIES = _ORDERTIF_POSSIBILITIES + [
    t.lower() for t in _ORDERTIF_POSSIBILITIES
]
