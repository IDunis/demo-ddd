...
import trapilot
import trapilot.blankly.exchanges.interfaces.binance.binance_websocket_utils as websocket_utils
from trapilot.blankly.exchanges.interfaces.websocket import Websocket
...
class Tickers(Websocket):
    def __init__(
        ...
        **kwargs,
        ...
        """
        # Reload preferences
        self.__preferences = trapilot.blankly.utils.load_user_preferences()
