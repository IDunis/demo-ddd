...
class FuturesExchange(ABCBaseExchange, abc.ABC):
    ...
    def initialize(self):
        ...
        This will report the exchange type to trapilot.blankly.reporter and initialize the cache for this exchange.
        """
        trapilot.blankly.reporter.export_used_exchange(self.exchange_type)
