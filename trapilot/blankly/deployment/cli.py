"""
    CLI for interacting with and uploading trapilot models.
...
from trapilot.blankly.utils.utils import info_print, load_deployment_settings, load_json_file
            ...
            if choice == "Create New":
                ...
                type_ = choose_option(
                    ...
                    [
                        ...
                        + TermColors.BOLD
                        + TermColors.WARNING
                        + "A strategy is a model that uses trapilot.blankly.Strategy"
                        + TermColors.ENDC,
                        "\t"
                        + TermColors.BOLD
                        + TermColors.WARNING
                        + "A screener is a model uses trapilot.blankly.Screener"
                        + TermColors.ENDC,
                    ],
                )
...
def main():
    ...
    if which == "deploy":
        ...
        if "error" in response:
            ...
            url = f"https://app.trapilot.finance/{api.user_id}/{response['modelId']}/overview"
            webbrowser.open(url)
