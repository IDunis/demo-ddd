...
from trapilot.blankly.LIB.exchange import timeframe_to_next_date
from trapilot.blankly.persistence.models import PairLock
...
class PairLocks:
    ...
    def is_pair_locked(
        ...
        return len(
            PairLocks.get_pair_locks(pair, now, side)
        ) > 0 or PairLocks.is_global_lock(now, side)
