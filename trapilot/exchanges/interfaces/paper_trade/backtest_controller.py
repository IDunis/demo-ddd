...
from trapilot.exchanges.interfaces.paper_trade.futures.futures_paper_trade_interface import FuturesPaperTradeInterface
...
from trapilot.utils.utils import load_backtest_preferences, write_backtest_preferences, info_print, update_progress, \
...
from trapilot.data.data_reader import PriceReader, TickReader, DataReader, FundingRateEventReader
...
class BackTestController(ABCBacktestController):  # circular import to type model
    ...
    def format_account_data(self, interface: PaperTradeInterface, local_time) -> \
        ...
        try:
            ...
            raise KeyError(f"Failed looking up {e}. Try changing your quote_account_value_in in user_data/backtest.json to be "
