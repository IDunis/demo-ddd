...
class Reporter:
    ...
    def export_backtest_result(self, platform_result: dict):
        ...
        Args:
            platform_result: A trapilot backtest result object
        """
        pass
    ...
    def text(self, text: str):
        """
        Send a text message to the number if user_data/notify.json OR the phone number attached to your account if the model
        is deployed live
    ...
    def email(self, email: str):
        """
        Send an email to the email specified in the user_data/notify.json OR your user account email if run live
    ...
    def chat(self, message: str):
        ...
        Create the webhook following these instructions:
            ...
            5. In the Name field, enter a name for your webhook (such as "Trapilot Notifications").
            6. In the Avatar URL field, enter a URL to an icon (such as https://trapilot.finance/_nuxt/img/trapilot-black.c8ffff6.svg).
            7. Click Save.
