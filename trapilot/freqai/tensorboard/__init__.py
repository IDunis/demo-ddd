...
try:
    from trapilot.freqai.tensorboard.tensorboard import TensorBoardCallback, TensorboardLogger
    TBLogger = TensorboardLogger
    TBCallback = TensorBoardCallback
except ModuleNotFoundError:
    from trapilot.freqai.tensorboard.base_tensorboard import (BaseTensorBoardCallback,
