...
from trapilot.strategy import IStrategy  # noqa
from trapilot.strategy import IntParameter, merge_informative_pair
...
class FreqaiExampleHybridStrategy(IStrategy):
    ...
    FreqAI to bolster a typical Trapilot strategy.

    Launching this strategy would be:

    trapilot trade --strategy FreqaiExampleHybridStrategy --strategy-path trapilot/templates
