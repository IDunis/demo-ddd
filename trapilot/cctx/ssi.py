...
class Ssi(Exchange, ImplicitAPI):
                    ...
                    "trading": {
                        ...
                        "tiers": {
                            "taker": [
                                ...
                                [
                                    self.parse_number("100000"),
                                    self.parse_number("0.0022"),
                                ],
                                [
                                    self.parse_number("500000"),
                                    self.parse_number("0.0020"),
                                ],
                                [
                                    self.parse_number("1000000"),
                                    self.parse_number("0.0018"),
                                ],
                                [
                                    self.parse_number("10000000"),
                                    self.parse_number("0.0015"),
                                ],
                                [
                                    self.parse_number("25000000"),
                                    self.parse_number("0.0013"),
                                ],
                                [
                                    self.parse_number("50000000"),
                                    self.parse_number("0.0012"),
                                ],
                                [
                                    self.parse_number("100000000"),
                                    self.parse_number("0.001"),
                                ],
                            ],
                            "maker": [
                                ...
                                [
                                    self.parse_number("1000000"),
                                    self.parse_number("0.0008"),
                                ],
                                [
                                    self.parse_number("10000000"),
                                    self.parse_number("0.0005"),
                                ],
                                [
                                    self.parse_number("25000000"),
                                    self.parse_number("0.0002"),
                                ],
                                [
                                    self.parse_number("50000000"),
                                    self.parse_number("0.0002"),
    ...
    def fetch_trades(
        ...
        method = self.safe_string(
            params, "method", "marketPublicGetV1beta3CryptoLocTrades"
        )
        request = {
            "symbols": marketId,
            "loc": loc,
        ...
        if method == "marketPublicGetV1beta3CryptoLocTrades":
            ...
            if limit is not None:
                request["limit"] = limit
            response = self.marketPublicGetV1beta3CryptoLocTrades(
                self.extend(request, params)
            )
        elif method == "marketPublicGetV1beta3CryptoLocLatestTrades":
            response = self.marketPublicGetV1beta3CryptoLocLatestTrades(
                self.extend(request, params)
            )
        else:
            raise NotSupported(
                self.id
                + " fetchTrades() does not support "
                + method
                + ", marketPublicGetV1beta3CryptoLocTrades and marketPublicGetV1beta3CryptoLocLatestTrades are supported"
            )
        #
        # {
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        response = self.marketPublicGetV1beta3CryptoLocLatestOrderbooks(
            self.extend(request, params)
        )
        #
        #   {
        ...
        return self.parse_order_book(
            rawOrderbook, market["symbol"], timestamp, "b", "a", "p", "s"
        )
    ...
    def fetch_ohlcv(
        ...
        loc = self.safe_string(params, "loc", "us")
        method = self.safe_string(
            params, "method", "marketPublicGetV1beta3CryptoLocBars"
        )
        request = {
            "symbols": marketId,
            "loc": loc,
        ...
        if method == "marketPublicGetV1beta3CryptoLocBars":
            ...
            request["timeframe"] = self.safe_string(
                self.timeframes, timeframe, timeframe
            )
            response = self.marketPublicGetV1beta3CryptoLocBars(
                self.extend(request, params)
            )
        elif method == "marketPublicGetV1beta3CryptoLocLatestBars":
            response = self.marketPublicGetV1beta3CryptoLocLatestBars(
                self.extend(request, params)
            )
        else:
            raise NotSupported(
                self.id
                + " fetchOHLCV() does not support "
                + method
                + ", marketPublicGetV1beta3CryptoLocBars and marketPublicGetV1beta3CryptoLocLatestBars are supported"
            )
        #
        #    {
        #        "bars":{
    ...
    def create_order(
        ...
        if triggerPrice is not None:
            ...
            if type.find("limit") >= 0:
                ...
                raise NotSupported(
                    self.id
                    + " createOrder() does not support stop orders for "
                    + type
        ...
        return self.safe_order(
            {
                ...
                "symbol": symbol,
                "type": orderType,
                "timeInForce": self.parse_time_in_force(
                    self.safe_string(order, "time_in_force")
                ),
                "postOnly": None,
